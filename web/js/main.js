...
$(function () {
    ...
    myGeo.getPoint("四川省成都市成华区建设北路二段4号", function(point){
        if (point) {
    ...
    /**************************Leaflet地图API功能**********************************/
    var map = L.map('allmap').setView([30.676784488041973, 104.10064182101205], 13);
    L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map);
    L.marker([30.676784488041973, 104.10064182101205]).addTo(map)
        .bindPopup('电子科技大学（沙河校区）.<br> 四川省成都市成华区建设北路二段4号.')
        .openPopup();
});
